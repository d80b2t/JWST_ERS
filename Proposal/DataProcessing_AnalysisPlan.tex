...
CALIFU3 level data and analyze this.  We note there is already Python
...
\vspace{-6pt}
All Co-Is are part of the ``core team''.  
A team biography and SEP tasks of our team can be found
\href{https://github.com/d80b2t/JWST_ERS/blob/master/Proposal/CoI_bios.tex}{\tt here}
and the SEP Deliverables are
\href{https://github.com/d80b2t/JWST_ERS/tree/master/Deliverables}{\tt
here}.
{\it We are acutely aware that our team currently has a gender binary split of 7:14
F:M and is predominantly White European or White American.}
...
%{\it Given the pixel scales of the MRS IFU, and the fact that 1'' is
